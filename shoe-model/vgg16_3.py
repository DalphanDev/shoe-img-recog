...
train_images_augmented = data_generator.flow(train_images.reshape(-1, 299, 299, 1), batch_size=len(train_images), shuffle=False).next()
...
model.save("shoeSilhouetteModel_VGG16_3.h5")
