...
model = load_model(os.path.join(
    os.getcwd(), "sku-models/models/jordan-2-low/jordan2Low_VGG16.h5"))
...
image_path = os.path.join(
    os.getcwd(), "sku-models/models/jordan-2-low/prediction/img2.jpg")

# Preprocess the image using the prediction ImageDataGenerator
preprocessed_img = preprocess_image(
    image_path, image_size, prediction_data_gen)

# Create the label map
train_dir = os.path.join(os.getcwd(), "sku-models/models/jordan-2-low/train")
