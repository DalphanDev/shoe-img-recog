...
model = load_model(os.path.join(
    os.getcwd(), "sku-models/models/jordan-2/jordan2_VGG16.h5"))
...
image_path = os.path.join(
    os.getcwd(), "sku-models/models/jordan-2/prediction/img.jpg")
...
train_dir = os.path.join(os.getcwd(), "sku-models/models/jordan-2/train")
